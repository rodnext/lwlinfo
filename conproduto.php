...
<hr>
    ...
    <span><a class="container">Buscando: <?php 
          ...
          <a href="cadprod.php" class="btn btn-sm btn-primary">Cadastrar Novo</a><hr>
    </div>        
<hr>
  <div class="row">
<?php  // noticias.php
...
<?php //codigo produtos
        ...
        while ($linha = mysqli_fetch_array($qry)){
            ...
            <td><a href="edtproduto.php?idproduto=<?php echo $linha['idproduto'] ?>"><img src="img/editar.png" width="25" height="25"></a>
            <a href="dltproduto.php?idproduto=<?php echo $linha['idproduto'] ?>"><img src="img/excluir.png" width="25" height="25"></a></td>
