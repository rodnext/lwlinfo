    ...
    <hr>
      ...
      <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <label>Celular</label>
              <input type="text" class="form-control" maxlength="11" placeholder="(XX)XXXXX-XXXX" name='telefone'>
            </div>     
      ...
      .btn-primary {
            ...
            <button type="submit" class="btn btn-primary">Cadastrar-se</button><br><br>
    </form>  
